<div class="container">
    <ol class="breadcrumb well well-sm">
        ...
        <li class="active"><?php echo __('Organisationseinheit bearbeiten'); ?></li>
    </ol>
    ...
    <h1><?php echo __('Organisationseinheit bearbeiten'); ?></h1>
    <fieldset>
        <legend><?php echo __('Hier können Sie die Daten der Organisationseinheit bearbeiten'); ?></legend>
